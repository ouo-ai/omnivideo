    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link 
            href="#generator"
            className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-5 py-2 rounded-full text-sm font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all flex items-center gap-2"
          >
          ...
          >
            <div className="flex flex-col items-center gap-8">
              ...
              <Link 
                href="#generator"
                onClick={() => setIsMobileMenuOpen(false)}
                className="mt-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-3 rounded-full text-lg font-semibold flex items-center gap-2"
              >
